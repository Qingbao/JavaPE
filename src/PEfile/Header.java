...
public class Header implements Cloneable, BinaryRecord {
     ...
     */
        ...
        out.println("SizeOfInitializedData = 0x" + Long.toHexString(sizeOfInitializedData));
        out.println("SizeOfUninitializedData = 0x" + Long.toHexString(sizeOfUninitializedData));
        out.println("AddressOfEntryPoint = 0x" + Long.toHexString(addressOfEntryPoint));
        out.println("BaseOfCode = 0x" + Long.toHexString(baseOfCode));
        out.println("BaseOfData = 0x" + Long.toHexString(baseOfData));
        out.println("ImageBase = 0x" + Long.toHexString(imageBase));
        out.println("SectionAlignment = 0x" + Long.toHexString(sectionAlignment));
        out.println("FileAlignment = 0x" + Long.toHexString(fileAlignment));
        out.println("MajorOperatingSystemVersion = 0x"+ Integer.toHexString(majorOperatingSystemVersion));
        out.println("MinorOperatingSystemVersion = 0x"+Integer.toHexString(minorOperatingSystemVersion));
        out.println("MajorImageVersion = 0x" + Integer.toHexString(majorImageVersion));
        out.println("MinorImageVersion = 0x" + Integer.toHexString(minorImageVersion));
        out.println("MajorSubsystemVersion = 0x" + Integer.toHexString(majorSubsystemVersion));
        out.println("MinorSubsystemVersion = 0x" + Integer.toHexString(minorSubsystemVersion));
        out.println("Reserved1 = 0x" + Long.toHexString(reserved1));
        out.println("SizeOfImage = 0x" + Long.toHexString(sizeOfImage));
        out.println("SizeOfHeaders = 0x" + Long.toHexString(sizeOfHeaders));
        out.println("CheckSum = 0x" + Long.toHexString(checkSum));
        out.println("Subsystem = 0x" + Integer.toHexString(subsystem));
        out.println("DllCharacteristics = 0x"+ Integer.toHexString(dllCharacteristics));
        out.println("SizeOfStackReserve = 0x" + Long.toHexString(sizeOfStackReserve));
        out.println("SizeOfStackCommit = 0x" + Long.toHexString(sizeOfStackCommit));
        out.println("SizeOfHeapReserve = 0x" + Long.toHexString(sizeOfHeapReserve));
        out.println("SizeOfHeapCommit = 0x" + Long.toHexString(sizeOfHeapCommit));
        out.println("LoaderFlags = 0x" + Long.toHexString(loaderFlags));
        out.println("NumberOfRvaAndSizes = 0x" + Long.toHexString(numberOfRvaAndSizes));
        out.println("ExportDirectory_VA = 0x" + Long.toHexString(exportDirectory_VA));
        out.println("ExportDirectory_Size = 0x" + Long.toHexString(exportDirectory_Size));
        out.println("ImportDirectory_VA = 0x" + Long.toHexString(importDirectory_VA));
        out.println("ImportDirectory_Size = 0x" + Long.toHexString(importDirectory_Size));
        out.println("ResourceDirectory_VA = 0x" + Long.toHexString(resourceDirectory_VA));
        out.println("ResourceDirectory_Size = 0x" + Long.toHexString(resourceDirectory_Size));
        out.println("ExceptionDirectory_VA = 0x" + Long.toHexString(exceptionDirectory_VA));
        out.println("ExceptionDirectory_Size = 0x" + Long.toHexString(exceptionDirectory_Size));
        out.println("SecurityDirectory_VA = 0x" + Long.toHexString(securityDirectory_VA));
        out.println("SecurityDirectory_Size = 0x" + Long.toHexString(securityDirectory_Size));
        out.println("BaseRelocationTable_VA = 0x" + Long.toHexString(baseRelocationTable_VA));
        out.println("BaseRelocationTable_Size = 0x" + Long.toHexString(baseRelocationTable_Size));
        out.println("DebugDirectory_VA = 0x" + Long.toHexString(debugDirectory_VA));
        out.println("DebugDirectory_Size = 0x" + Long.toHexString(debugDirectory_Size));
        out.println("ArchitectureSpecificData_VA = 0x"+ Long.toHexString(architectureSpecificData_VA));
        out.println("ArchitectureSpecificData_Size = 0x"+ Long.toHexString(architectureSpecificData_Size));
        out.println("RVAofGP_VA = 0x" + Long.toHexString(rvaofGP_VA));
        out.println("RVAofGP_Size = 0x" + Long.toHexString(rvaofGP_Size));
        out.println("TLSDirectory_VA = 0x" + Long.toHexString(tlsDirectory_VA));
        out.println("TLSDirectory_Size = 0x" + Long.toHexString(tlsDirectory_Size));
        out.println("LoadConfigurationDirectory_VA = 0x"+ Long.toHexString(loadConfigurationDirectory_VA));
        out.println("LoadConfigurationDirectory_Size = 0x"+ Long.toHexString(loadConfigurationDirectory_Size));
        out.println("BoundImportDirectoryinheaders_VA = 0x"+ Long.toHexString(boundImportDirectoryinheaders_VA));
        out.println("BoundImportDirectoryinheaders_Size = 0x"+ Long.toHexString(boundImportDirectoryinheaders_Size));
        out.println("ImportAddressTable_VA = 0x" + Long.toHexString(importAddressTable_VA));
        out.println("ImportAddressTable_Size = 0x" + Long.toHexString(importAddressTable_Size));
        out.println("DelayLoadImportDescriptors_VA = 0x"+ Long.toHexString(delayLoadImportDescriptors_VA));
        out.println("DelayLoadImportDescriptors_Size = 0x"+ Long.toHexString(delayLoadImportDescriptors_Size));
        out.println("COMRuntimedescriptor_VA = 0x" + Long.toHexString(comRuntimedescriptor_VA));
        out.println("COMRuntimedescriptor_Size = 0x"+ Long.toHexString(comRuntimedescriptor_Size));
    }
